...
class ExpenseFileReaderTest {
	...
	void testLoadExpenses() {
		...
		// Test lines from expenses.txt file
		String [] expectedLinesArray2 = {
			"1,57.38",
			"2,32.88",
			"3 44.64",
			"4,3.09",
		...
		List<String> expectedExpensesList = new ArrayList<String>(Arrays.asList(expectedLinesArray2));
		
		//compare to actual lines of expenses_sample.txt file
		assertEquals(expectedExpensesList, this.expensesList, "The expected 3 lines do not match the actual 16 lines from the sample expenses.");
